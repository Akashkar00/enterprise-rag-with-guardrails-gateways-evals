...
from evals.auth import get_auth_headers
...
def _get_summary_client() -> OpenAI:
    """Groq client for the summarization step — uses JUDGE_GROQ_API to avoid touching the prod key."""
    key = os.getenv("JUDGE_GROQ_API") or os.getenv("GROQ_API_KEY")
